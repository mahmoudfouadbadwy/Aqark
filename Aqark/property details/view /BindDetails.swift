...
extension PropertyDetailView{
    ...
    private func setSpecification()
    {
        ...
        if "lang".localize == "en"{
            ...
            self.specification.text = "\(self.advertisementDetails.propertyType.localize ) \("for".localize)\(self.advertisementDetails.advertismentType.localize ) \("in".localize) \(self.advertisementDetails.country.localize.split(separator: ",")[1] )"
        }
    }
